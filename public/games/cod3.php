...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/pages/games/cod3.css">
</head>
<style>
    :root {
            ...
            <div class="section-block">
                ...
                <div class="products-grid" id="productsGrid">
                    ...
                    <div class="product-card battlepass-card" data-id="11" data-pts="Battle Pass" data-price="106187"
                        data-original="380000" data-discount="72">
                        <img src="https://static.wikia.nocookie.net/callofduty/images/4/4e/COD_Points_stack_5000_BO3.png/revision/latest?cb=20151218135441"
                            style="height: 40px; width: 40px" alt="">
                        <div class="product-card__pts">Battle Pass</div>
                        <div class="product-card__label">Puntos</div>
                        <div class="product-card__price-old">380.000 COP</div>
                        <div class="product-card__price">106.187 COP <span class="discount-tag">-72%</span></div>
                    </div>
            ...
            <div class="checkout-summary">
                ...
                <div class="checkout-row checkout-total-row">
                    ...
                    <div class="checkout-pricing">
                        <span id="checkoutOriginal" class="checkout-original"></span>
                        <div class="checkout-final-row">
                            <span id="checkoutBadge" class="checkout-badge"></span>
                            <span id="checkoutPrice" class="checkout-final-price"></span>
                        </div>
                    </div>
                </div>
                ...
                <div style="position: relative;">
                    <button class="btn-buy" id="btnBuy">
                        Comprar ahora <span class="btn-arrow">→</span>
                    </button>
                    <div class="buy-tooltip">
                        <p class="buy-tooltip__text">Se enviará la siguiente información al proveedor:</p>
