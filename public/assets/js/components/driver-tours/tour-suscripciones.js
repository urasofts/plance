        ...
        steps: [
            {
                element: '#tipo-flujo',
                popover: {
                    title: 'Elige como pagar en el ejemplo',
                    description:
                        'Aqui puedes cambiar entre Web Checkout y API Gateway. Piensalo como dos caminos para que un cliente pague en tu comercio: uno mas guiado y otro mas integrado con tu sistema.'
                }
            },
            {
                element: '#tipo-suscripcion-mixta',
                popover: {
                    title: 'Pago inicial mas suscripcion',
                    description:
                        'Esta etiqueta indica un flujo donde el cliente hace un primer pago para activar el servicio y luego queda con la suscripcion asociada.'
                }
            },
            {
                ...
                popover: {
                    ...
                    description:
                        'En este tipo de ejemplo, despues del alta inicial, los cobros se realizan automaticamente segun la frecuencia definida por el comercio.'
                }
            },
            {
                element: '#tarjeta',
                popover: {
                    ...
                    description:
                        'Estas tarjetas simulan lo que veria un cliente final. Al hacer clic en Productos se abre el flujo de compra para iniciar la suscripcion en PlacetoPay.',
                    onNextClick: () => {
                        localStorage.setItem('tutorial', 'pendiente');
                        driver.destroy();
