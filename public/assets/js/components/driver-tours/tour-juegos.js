        ...
        steps: [
            {
                ...
                popover: {
                    ...
                    description: `
						Aquí puedes elegir el tipo de integración que deseas explorar. Cada opción muestra ejemplos de compra 
                        utilizando una forma diferente de conectar tu comercio con Place to Pay
				`
                }
            },
            {
                element: '#tipo-servicio-basico',
                popover: {
                    title: 'Tipo de ejemplo',
                    description: `
                        Esta etiqueta indica la modalidad del ejemplo que estás viendo. 
                        "Pago Básico" representa un flujo de compra sencillo, ideal para 
                        conocer el proceso estándar de un pago en línea.
                        `
                }
            },
            {
                element: '#tipo-servicio-mixto',
                popover: {
                    title: 'Tipo de ejemplo',
                    description: `
                        "Pago Mixto" muestra un proceso de compra donde se pueden combinar 
                        varias opciones de pago para completar una transacción.
                        `
                }
            },
            {
                ...
                popover: {
                    ...
                    description: `
                        Estas tarjetas representan un articulo disponible para la venta. 
                        Haz clic en "Productos" para conocer las opciones de compra y 
                        continuar con la experiencia de pago del ejemplo.
                    `,
                    onNextClick: () => {
                        localStorage.setItem('tutorial', 'pendiente');
                        driver.destroy();
