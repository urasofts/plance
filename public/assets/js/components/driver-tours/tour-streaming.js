document.addEventListener('DOMContentLoaded', () => {
    ...
    const driver = window.driver.js.driver({
        ...
        steps: [
            ...
            {
                element: '#parcialCheck',
                popover: {
                    title: 'Opción de pago mixto',
                    description:
                        'Esta casilla habilita un ejemplo de pago mixto. Al activarla, podrás ver cómo cambia la experiencia de compra cuando se utilizan múltiples opciones de pago para completar una transacción.'
                }
            },
            {
                element: '#btnPagar',
                popover: {
                    ...
                    description:
                        'Después de seleccionar un producto e ingresar los datos solicitados, el usuario haría clic en "Comprar ahora". En este punto comienza la integración con el Web Checkout de Place to Pay.'
                }
            },
            {
                popover: {
            ...
            },
            {
                popover: {
                    ...
                    description:
                        'Después de procesar la solicitud, Place to Pay devuelve una processUrl. El backend redirige al usuario a esa URL para que complete el proceso de Web Checkout de forma segura.'
                }
            }
        ]
    });
