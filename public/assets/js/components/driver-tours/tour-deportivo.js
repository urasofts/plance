document.addEventListener('DOMContentLoaded', () => {
        ...
        steps: [
            {
                element: '#tipo-flujo',
                popover: {
                    title: 'Canal de pago del ejemplo',
                    description:
                        'Este selector muestra el canal disponible para esta categoria. En este caso veras un flujo con API Link de pagos, ideal para compartir un enlace de cobro al cliente.'
                }
            },
            {
                element: '#tipo-link-pagos',
                popover: {
                    title: 'Pago por enlace',
                    description:
                        'Esta etiqueta indica que el cobro se hace por medio de un link. El comercio genera el enlace y el cliente lo abre para completar el pago de forma segura con PlacetoPay.'
                }
            },
            {
                element: '#tarjeta',
                popover: {
                    title: 'Selecciona un kit para comprar',
                    description:
                        'Cada tarjeta representa un producto que el cliente puede adquirir. Al entrar en Productos veras el ejemplo completo del flujo de compra con enlace de pago.',
                    onNextClick: () => {
                        localStorage.setItem('tutorial', 'pendiente');
                        driver.destroy();
    ...
    iniciarTutorialButton.addEventListener('click', iniciarTourDeportivo);
